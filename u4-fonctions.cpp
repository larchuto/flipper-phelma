...
void DeplacerBouleAvecRebonds()
{
	...
	*/
	...
	gravite = 9.81*3779/5;
    float INCLINAISO = 1.5;
    float a= sin(INCLINAISO*3.141459/180);
    float b= cos(INCLINAISO*3.141459/180);

		// Nouvelle position de la boule ...


gDonnees.Boule.AX=0;
    gDonnees.Boule.AY=gravite*a;

    float frotte=0.01;

   if (fabs(gDonnees.Boule.VX)>0.01)
   {
       gDonnees.Boule.AX=-b*gravite*fabs(gDonnees.Boule.VX)/gDonnees.Boule.VX*frotte;
   }

    if (fabs(gDonnees.Boule.VY)>0.01)
    {
        gDonnees.Boule.AY=gravite*(a-fabs(gDonnees.Boule.VY)/gDonnees.Boule.VY*b*frotte);
    }

    gDonnees.Boule.X = gDonnees.Boule.X + gDonnees.Boule.VX*DUREE_CYCLE+ gDonnees.Boule.AX/2*DUREE_CYCLE*DUREE_CYCLE ;
    gDonnees.Boule.Y = gDonnees.Boule.Y + gDonnees.Boule.VY*DUREE_CYCLE + gDonnees.Boule.AY/2*DUREE_CYCLE*DUREE_CYCLE ;
    gDonnees.Boule.VX=gDonnees.Boule.VX+ gDonnees.Boule.AX*DUREE_CYCLE;
    gDonnees.Boule.VY=gDonnees.Boule.VY + gDonnees.Boule.AY*DUREE_CYCLE;
    gDonnees.Boule.Em=gDonnees.Boule.VY*gDonnees.Boule.VY/2 + a*gravite*(400-gDonnees.Boule.Y);
